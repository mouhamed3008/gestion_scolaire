...
class ProfesseurController extends AbstractController
{
    ...
    public function detail(ManagerRegistry $doctrine, int $id, ProfesseurRepository $rep, ModuleRepository $repositoryModule): Response
    {
        // dd($professeur);
        $professeur = $doctrine->getRepository(Professeur::class)->find($id);
        $categoryName = $rep->findOneByIdJoinedToClasses($id);
        $categoryName = $repositoryModule->findOneByIdJoinedToModules($id);
        dd($categoryName);
