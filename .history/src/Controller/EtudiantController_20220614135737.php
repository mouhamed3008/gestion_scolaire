...
class EtudiantController extends AbstractController
{
    ...
    public function add(Request $request, ManagerRegistry $doctrine, MailerService $mailer, SessionInterface $session)
    {
        ...
        $inscription = new Inscription();
         ...
         if ($form->isSubmitted() ) { 
             ...
             $an = $doctrine->getRepository(AnneeScolaire::class)->findOneBy(['isActif'=>1]);
