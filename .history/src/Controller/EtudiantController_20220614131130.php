...
class EtudiantController extends AbstractController
{
    ...
    public function add(Request $request, ManagerRegistry $doctrine, ClasseRepository $repository, MailerService $mailer, SessionInterface $session)
    {
        ...
        dd($session->get('annees'));
         ...
         if ($form->isSubmitted() ) { 
             ...
             $inscription->setAnneeScolaire($session->get('annees'));
